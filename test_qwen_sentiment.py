...
def load_trained_sentiment_model(model_path="./qwen_sentiment_model"):
    """加载训练好的情感分析模型"""
...
def test_sentiment_model():
    ...
    print("\n=== 真实数据测试 ===")
    try:
        df = pd.read_csv("nasdaq_news_sentiment/sentiment_deepseek_new_cleaned_nasdaq_news_full.csv", nrows=50)
